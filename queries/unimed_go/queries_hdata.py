...
query_atend_categoria_convenio_hdata = "SELECT NR_ATENDIMENTO, CD_CONVENIO, NR_SEQ_INTERNO, CD_CATEGORIA, DT_INICIO_VIGENCIA FROM UNIMED_GYN.ATEND_CATEG_CONVENIO"
