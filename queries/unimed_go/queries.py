...
query_prescr_procedimento = "SELECT PP.IE_STATUS_ATEND, PP.NR_SEQ_EXAME, PP.NR_PRESCRICAO, PP.CD_PROCEDIMENTO, PP.IE_ORIGEM_PROCED, PP.NR_SEQUENCIA, PP.IE_VIA_APLICACAO, PP.DS_HORARIOS, PP.DS_JUSTIFICATIVA, AP.CD_ESTABELECIMENTO FROM TASY.VW_EXIMIO_PRESCR_PROCEDIMENTO PP INNER JOIN TASY.VW_EXIMIO_PRESCR_MEDICA_V PM ON PM.NR_PRESCRICAO = PP.NR_PRESCRICAO INNER JOIN TASY.VW_EXIMIO_ATENDIMENTO_PACIENTE AP ON PM.NR_ATENDIMENTO = AP.NR_ATENDIMENTO WHERE AP.DT_ENTRADA >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND AP.DT_ENTRADA < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"

query_prescr_medica_v = "SELECT DISTINCT PM.NR_ATENDIMENTO, PM.NR_PRESCRICAO, PM.DT_PRESCRICAO, CD_MEDICO_RESP FROM TASY.VW_EXIMIO_PRESCR_MEDICA_V PM INNER JOIN TASY.VW_EXIMIO_ATENDIMENTO_PACIENTE AP ON PM.NR_ATENDIMENTO = AP.NR_ATENDIMENTO WHERE AP.DT_ENTRADA >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND AP.DT_ENTRADA < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"
