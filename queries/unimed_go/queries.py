...
query_atendimento_paciente = "SELECT VAP.NR_ATENDIMENTO, VAP.NR_ATENDIMENTO_MAE, VAP.DT_ENTRADA, VAP.DT_INICIO_ATENDIMENTO, VAP.DT_ATEND_MEDICO, VAP.DT_ALTA, VAP.DT_ALTA_MEDICO, VAP.DT_FIM_TRIAGEM, VAP.NR_SEQ_TRIAGEM, VAP.DT_MEDICACAO, VAP.CD_MOTIVO_ALTA, VAP.CD_MOTIVO_ALTA_MEDICA, VAP.IE_TIPO_ATENDIMENTO, VAP.CD_PESSOA_FISICA, VAP.CD_MEDICO_RESP, VAP.NR_SEQ_PAC_SENHA_FILA, VAP.IE_CLINICA, VAP.CD_ESTABELECIMENTO, VAP.DS_SENHA_QMATIC, AP.NR_SEQ_CLASSIFICACAO, AP.DT_CANCELAMENTO FROM TASY.VW_HDATA_ATENDIMENTO_PACIENTE VAP INNER JOIN TASY.ATENDIMENTO_PACIENTE AP ON VAP.NR_ATENDIMENTO = AP.NR_ATENDIMENTO WHERE VAP.DT_ENTRADA >= TO_DATE('{dt}', 'DD/MM/YYYY') AND VAP.DT_ENTRADA < TO_DATE('{dt}', 'DD/MM/YYYY') + INTERVAL '1' DAY"

query_atendimento_paciente_canc = "SELECT VAP.NR_ATENDIMENTO, AP.DT_CANCELAMENTO FROM TASY.VW_HDATA_ATENDIMENTO_PACIENTE VAP INNER JOIN TASY.ATENDIMENTO_PACIENTE AP ON VAP.NR_ATENDIMENTO = AP.NR_ATENDIMENTO WHERE AP.DT_CANCELAMENTO IS NOT NULL AND VAP.DT_ENTRADA >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND VAP.DT_ENTRADA < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"
