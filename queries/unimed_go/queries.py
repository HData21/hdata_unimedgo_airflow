...
query_atendimento_paciente_canc = "SELECT VAP.NR_ATENDIMENTO, AP.DT_CANCELAMENTO FROM TASY.VW_HDATA_ATENDIMENTO_PACIENTE VAP INNER JOIN TASY.ATENDIMENTO_PACIENTE AP ON VAP.NR_ATENDIMENTO = AP.NR_ATENDIMENTO WHERE VA.DT_CANCELAMENTO IS NOT NULL AND VAP.DT_ENTRADA >= TO_DATE('{data_ini}', 'DD/MM/YYYY') "
