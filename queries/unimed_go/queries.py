...
query_ped_ex_ext = "SELECT NR_SEQUENCIA, NR_ATENDIMENTO, DT_INATIVACAO FROM TASY.VW_HDATA_PED_EX_EXT"

query_exame_lab = 'SELECT NR_SEQ_EXAME, NR_SEQ_GRUPO, NM_EXAME, DS_UNIDADE_MEDIDA FROM TASY.VW_HDATA_EXAME_LABORATORIO'

query_prescr_procedimento = 'SELECT IE_STATUS_ATEND, NR_SEQ_EXAME, NR_PRESCRICAO, CD_PROCEDIMENTO, IE_ORIGEM_PROCED, NR_SEQUENCIA, IE_VIA_APLICACAO, DS_HORARIOS, DS_JUSTIFICATIVA FROM TASY.VW_HDATA_PRESCR_PROCEDIMENTO'
...
query_atend_categoria_convenio = "SELECT ATEND_CATEGORIA_CONVENIO.NR_ATENDIMENTO, CD_CONVENIO, NR_SEQ_INTERNO, CD_CATEGORIA, DT_INICIO_VIGENCIA FROM TASY.VW_HDATA_ATEND_CATEG_CONVENIO"
...
query_pessoa_fisica_medico = "SELECT DISTINCT PESSOA_FISICA.CD_PESSOA_FISICA, IE_SEXO, DT_CADASTRO_ORIGINAL, NM_PESSOA_PESQUISA FROM TASY.VW_HDATA_PESSOA_FISICA_MEDICO"

query_pessoa_fisica_pac = "SELECT DISTINCT PESSOA_FISICA.CD_PESSOA_FISICA, DT_NASCIMENTO, IE_SEXO, DT_CADASTRO_ORIGINAL FROM TASY.VW_HDATA_PESSOA_FISICA_PAC"
